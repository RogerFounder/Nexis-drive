        ...
        <div className="flex flex-col gap-3">
          {laudos.map((laudo) => (
            <Link
              ...
              className="flex items-center justify-between rounded-2xl border border-zinc-200 bg-white p-4 transition-colors duration-150 hover:border-zinc-300 dark:border-zinc-800 dark:bg-zinc-900 dark:hover:border-zinc-700"
            >
              <div>
